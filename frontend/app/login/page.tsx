  ...
  return (
    <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
        ...
        <div className="relative flex items-center justify-center my-6">
          <span className="absolute px-2 bg-white text-gray-400 text-sm">Or continue with</span>
        ...
        <button
          ...
          className="flex items-center justify-center w-full py-2 mb-4 font-bold text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition"
        >
